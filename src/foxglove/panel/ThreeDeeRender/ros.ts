...
export type WayPoint = Readonly<{
  point_type: number|undefined;
  point_name:string|undefined;
  point_id:number|undefined;
  poses: Pose;
}>;
export type WayPointArray = Readonly<{
  header: Header;
  wayPoints: WayPoint[];
}>;
//yxd 20230609新增
export type RobotWayPoint = Readonly<{
  header: Header;
  points: WayPoint[];
}>;
...
addRosDataType(TF_DATATYPES, "robot_interfaces/TFMessage"); //2023-04-18 yxd
...
addRosDataType(OCCUPANCY_GRID_DATATYPES, "robot_interfaces/OccupancyGrid"); //2023-04-18 yxd
...
addRosDataType(LASERSCAN_DATATYPES, "robot_interfaces/LaserScan"); //2023-04-18 yxd
...
addRosDataType(NAV_PATH_DATATYPES, "robot_interfaces/Path");  //2023-04-18 yxd

export const WAY_POINT_DATATYPES =new Set<string>(); //yxd waypoint
addRosDataType(WAY_POINT_DATATYPES,"robot_interfaces/PoseArray"); //yxd waypoint
...
function addRosDataType(output: Set<string>, dataType: string): Set<string> {
  ...
  // Add the protobuf variation: for example tf2_msgs.TFMessage 2023-04-18 yxd
