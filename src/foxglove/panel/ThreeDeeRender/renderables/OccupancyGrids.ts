...
const DEFAULT_MIN_COLOR = { r: 27/255, g: 48/255, b: 66/255, a: 1 }; // 修改默认颜色  yxd 20230725
//const DEFAULT_MAX_COLOR = { r: 0, g: 0, b: 0, a: 1 }; // black
const DEFAULT_MAX_COLOR = { r: 100/255, g: 175/255, b: 209/255, a: 1 }; // 修改默认颜色  yxd 20230725
//const DEFAULT_UNKNOWN_COLOR = { r: 0.5, g: 0.5, b: 0.5, a: 1 }; // gray
const DEFAULT_UNKNOWN_COLOR = { r: 10/255, g: 15/255, b: 34/255, a: 1 }; // 修改默认颜色  yxd 20230725
