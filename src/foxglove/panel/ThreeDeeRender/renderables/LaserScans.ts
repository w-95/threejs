  ...
  private handleLaserScan = (
    ...
    if (!renderable) {
      ...
      if (settings.colorField == undefined) {
        ...
        settings.colorMode = "flat";    //修改LaserScan默认的颜色方式  yxd  20230725
        ...
        this.renderer.updateConfig((draft) => {
          ...
          updatedUserSettings.colorMap = settings.colorMap;  //修改LaserScan默认的颜色方式添加的  yxd  20230725
          updatedUserSettings.flatColor = settings.flatColor;
