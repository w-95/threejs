...
import { styled as muiStyled, useTheme } from '@mui/styles';
...
import { PanelRoot, PANEL_ROOT_CLASS_NAME } from "./PanelRoot";
import {
  useCurrentLayoutActions,
  useSelectedPanels,
} from "../context/CurrentLayoutContext";
import { usePanelCatalog } from "../context/PanelCatalogContext";
import {
  useWorkspaceStore,
  WorkspaceStoreSelectors,
} from "../context/WorkspaceContext";
import usePanelDrag from "../hooks/usePanelDrag";
import { TabPanelConfig } from "../types/layouts";
import { OpenSiblingPanel, PanelConfig, SaveConfig } from "../types/panels";
import {
  getPanelIdForType,
  getPanelTypeFromId,
  getPathFromNode,
...
const MosaicPathContext = createContext<MosaicPath | undefined>(undefined);
const ActionsOverlay = muiStyled("div")(({ theme }: any) => ({
  cursor: "pointer",
  position: "absolute",
  top: 0,
  left: 0,
...
const Container = muiStyled("div", {
  shouldForwardProp: (prop: string) => prop !== "direction",
})<{
...
>(
  ...
  function ConnectedPanel(props: Props<Config>) {
    ...
    let panelRootRef = useRef<HTMLDivElement>(null);
    ...
    const perfInfo = useRef<HTMLDivElement>(null);
    const quickActionsOverlayRef = useRef<HTMLDivElement>(null);
          ...
          >
            {(fullscreenState) => (
              ...
              >
                ...
                {type !== 'Tab' && quickActionsKeyPressed && !fullscreen && (
                  <ActionsOverlay
                    ref={(el) => {
